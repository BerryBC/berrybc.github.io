...
More often, their promotion is driven by a mindset of **“others have it, so we must have it too—even if it’s useless, we can’t afford not to have it.”**
That is: technology comes first, and use cases are searched for afterward. Frankly speaking, this is no different from earlier waves such as **Big Data**, **the Metaverse**, or **Blockchain**.
...
Many “one-click” website, app, or game generators online illustrate this well:
the results are often crude or highly homogenized.
...
**code is generated in seconds, bugs are fixed for years**.
